...
<div class="pub-row">
  ...
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
    <img src="assets/img/Any2Seg.jpg" class="teaser img-fluid z-depth-1">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <div class="periodical"><em>The European Conference on Computer Vision <strong>(ECCV) <span style="color: red;">Oral (1.5%)</span></strong>, 2024.</em></div>
    <div class="links">
...
<div class="pub-row">
  ...
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
    <img src="assets/img/eventdance.jpg" class="teaser img-fluid z-depth-1">
...
<div class="pub-row">
  ...
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
    <img src="assets/img/360sfuda.jpg" class="teaser img-fluid z-depth-1">
    <abbr class="badge">CVPR 2024</abbr>
  </div>
...
<div class="pub-row">
  ...
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
    <img src="assets/img/exact.jpg" class="teaser img-fluid z-depth-1">
    <abbr class="badge">CVPR 2024 Hightlight</abbr>
  </div>

  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    <div class="title"><a href="">ExACT: Language-guided Conceptual Reasoning and Uncertainty Estimation for Event-based Action Recognition and More
</a></div>
    <div class="author">Jiazhou Zhou, <strong>Xu Zheng</strong>, Yuanhuiyi Lyu, Lin Wang</div>
...
<!--       <a href="[https://github.com/Hanchao-Zhang/KTensors](https://github.com/jiazhou-garland/ExACT)" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">GitHub</a>
      <a href="https://pypi.org/project/KTensors/" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Package</a>
      <a href="assets/files/KTensors.bib" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">BibTeX</a> -->
    </div>
  </div>
...
<div class="pub-row">
  ...
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
    <img src="assets/img/goodsam.jpg" class="teaser img-fluid z-depth-1">
    <abbr class="badge">CVPR 2024</abbr>
  </div>

  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    <div class="title"><a href="">GoodSAM: Bridging Domain and Capacity Gaps via Segment Anything Model for Distortion-aware Panoramic Semantic Segmentation
</a></div>
    <div class="author">Weiming Zhang, Ye xin Liu, <strong>Xu Zheng</strong>, Lin Wang</div>
    <div class="periodical"><em>The IEEE/CVF Conference on Computer Vision and Pattern Recognition <strong>(CVPR)</strong>, 2024.</em></div>
    <div class="links">
    <a href="" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Homepage</a>
      <a href="" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">PDF</a>
...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <div class="author">Yuanhuiyi Lyu, <strong>Xu Zheng</strong>, Lin Wang</div>
...
<div class="pub-row">
  ...
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
    <img src="assets/img/distill.jpg" class="teaser img-fluid z-depth-1">
    <abbr class="badge">arXiv</abbr>
  </div>

  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    <div class="title"><a href="https://arxiv.org/pdf/2401.17664">Distilling Efficient Vision Transformers from CNNs for Semantic Segmentation</a></div>
    <div class="author"><strong>Xu Zheng</strong>, Yunhao Luo, Pengyuan Zhou, Lin Wang</div>
    <div class="periodical"><em>arXiv <strong>(arXiv)</strong>, 2024.</em></div>
    <div class="links">
    <a href="" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Homepage</a>
      <a href="" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">PDF</a>
...
<div class="pub-row">
  ...
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
    <img src="assets/img/tcc.jpg" class="teaser img-fluid z-depth-1">
...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <div class="author">Jiahang Cao, <strong>Xu Zheng*</strong>, Yuanhuiyi Lyu*, Jiaxu Wang, Renjing Xu, Lin Wang</div>
    <div class="periodical"><em>The 2024 IEEE International Conference on Robotics and Automation <strong>(ICRA)</strong>, 2024.</em></div>
    <div class="links">
    <a href="https://vlislab22.github.io/EOLO/" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Homepage</a>
      <a href="https://arxiv.org/pdf/2309.09297.pdf" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">PDF</a>
...
<div class="pub-row">
  ...
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
    <img src="assets/img/datr.jpg" class="teaser img-fluid z-depth-1">
...
<div class="pub-row">
  ...
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
    <img src="assets/img/goodstu.jpg" class="teaser img-fluid z-depth-1">
    <abbr class="badge">CVPR 2023</abbr>
  </div>
...
<div class="pub-row">
  ...
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
    <img src="assets/img/dppass.jpg" class="teaser img-fluid z-depth-1">
    <abbr class="badge">CVPR 2023</abbr>
  </div>
...
<div class="pub-row">
  ...
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
    <img src="assets/img/eventsurvey.jpg" class="teaser img-fluid z-depth-1">
...
<div class="pub-row">
  ...
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
    <img src="assets/img/advseg.jpg" class="teaser img-fluid z-depth-1">
    <abbr class="badge">CIBM 2023</abbr>
  </div>

  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    <div class="title"><a href="">Adversarial co-training for semantic segmentation over medical images
</a></div>
    <div class="author">Haoyu Xie, Chong Fu, <strong>Xu Zheng</strong>, Yu Zheng, Chiu-Wing Sham, Xingwei Wang</div>
...
<div class="pub-row">
  ...
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
    <img src="assets/img/uncertea.jpg" class="teaser img-fluid z-depth-1">
    <abbr class="badge">CIBM 2022</abbr>
  </div>

  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    <div class="title"><a href="">Uncertainty teacher with dense focal loss for semi-supervised medical image segmentation
</a></div>
    <div class="author">Jialei Chen, Chong Fu, Haoyu Xie, <strong>Xu Zheng*</strong>, Rong Geng, Chiu-Wing Sham</div>
    <div class="periodical"><em>Computers in Biology and Medicine.</em></div>
    <div class="links">
    <a href="" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Homepage</a>
      <a href="" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">PDF</a>
...
<div class="pub-row">
  ...
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
    <img src="assets/img/uncer.jpg" class="teaser img-fluid z-depth-1">
    <abbr class="badge">CIBM 2022</abbr>
  </div>
